...
class AgendaService {
   public:
    ...
    bool changePassword(const std::string userName, const std::string password1, const std::string password2);
    bool changeEmail(const std::string userName, const std::string email1, const std::string email2);
    bool changePhoneNumber(const std::string userName, const std::string phone1, const std::string phone2);
